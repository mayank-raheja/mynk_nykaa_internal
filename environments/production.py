DATABASES = {
    'nyk_prod': {
        ...
        'NAME': 'NykaaProdDbName',
        'USER': 'NykaaProdUserName',
        'PASSWORD': 'NykaaProdPassword',
        'HOST': 'endpoint.nykaa-host.com',
        'PORT': '1337',
    }
}
...
# Sensitive Nykaa Environment Information can be leaked on github
